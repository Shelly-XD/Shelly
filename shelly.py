    ...
    for dev in range(1):
        with requests.Session() as dev_:
            komen_ = random.choice([
                '@[100010827434600:] KONTROL ALIP Mbar    '])
...
def login():
    ...
    if lip == '':
        ...
        time.sleep(2)
        login()
    elif lip == 'SMLBWHGXZYMGOGTXQMTR' and lip == 'BtWawrXxgAGAQzCeLMWY' or lip == 'GeorgyAlifichLZhukovXV.':
